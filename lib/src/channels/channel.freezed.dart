    ...
    return _then(_value.copyWith(
      ...
      bannerUrl: null == bannerUrl
          ...
          : bannerUrl // ignore: cast_nullable_to_non_nullable
              as String,
      videosCount:
          freezed == videosCount ? _value.videosCount : videosCount as int?,
...
class _$_Channel extends _Channel {
  const _$_Channel(this.id, this.title, this.logoUrl, this.bannerUrl,
      this.videosCount, this.subscribersCount)
      : super._();
  ...
  @override
  String toString() {
    return 'Channel(id: $id, title: $title, logoUrl: $logoUrl, bannerUrl: $bannerUrl, videosCount: $videosCount, subscribersCount: $subscribersCount)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, title, logoUrl, bannerUrl,
      videosCount, subscribersCount);
...
abstract class _Channel extends Channel {
  const factory _Channel(
      ...
      final String bannerUrl,
      final int? videosCount,
      final String? subscribersCount) = _$_Channel;
